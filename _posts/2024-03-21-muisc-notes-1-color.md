...
笔记的内容与形式不限，但态度不宜潦草。这个不知能续更几篇的系列将遵守以下规范：
...
下面来听 [1.2] Rameau: Suite in A minor，我比较喜欢的三版录音恰好都来自法国演奏家——
...
自上世纪始，GV 的主流诠释就形成了羽管键琴和钢琴的「党争」格局，两边都涌现了众多杰出演绎。
在接下来的实验中，我选择了自己喜欢的六个巴洛克羽管键琴版本——
...
经过相当工作量的听辨后，得到了它们的色块图。考虑 GV 的 30 个变奏符合三首一组的 triplet 结构，图中它们就也三格一行排成十行，最上和最下是 Aria 及其重复。这种排列的另一处方便是，对应变奏中 9 首依次为 <span style="margin-left:-0.05em; margin-right:0.05em;">_n_</span> 度卡农 V[3<span style="margin-left:-0.05em; margin-right:0.05em;">_n_</span>] (_n_ = 1, 2, ... , 9) 的 9 个色块正好从上至下排在最右列；同理，多数炫技变奏位于中列，传统舞曲位于左列。
...
关于乐器：Brendel (1988) 和 Anderszewski (2000) 演奏现代钢琴；Staier (2010) 和 Brautigam (2015) 演奏当代复制的两台几乎与 DV 同龄的 Conrad Graf (Wien, 1827/1824) 早期钢琴。
