...
经常做实验的朋友们都知道，任何度量工具或方法必先经过校准 (calibration) 才有意义。于是我决定在对 GV 或 DV 下手之前，先简单训练一下自己对上述「音乐色彩」标度的感知力。考虑到与正式实验、特别是 GV 的关联，我选择了两段自己喜欢的巴洛克键盘作品——
...
两部完整作品都属于巴洛克组曲 (Baroque suite)，最后一段都采用了放飞自我的主题—变奏曲式。
